...
"""autogenerated by genpy from interfaces/MoveRobotActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveRobotActionResult(genpy.Message):
  ...
  _type = "interfaces/MoveRobotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','interfaces/MoveRobotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = interfaces.msg.MoveRobotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = interfaces.msg.MoveRobotResult()
