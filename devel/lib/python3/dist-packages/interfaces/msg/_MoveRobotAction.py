...
"""autogenerated by genpy from interfaces/MoveRobotAction.msg. Do not edit."""
import codecs
import sys
...
class MoveRobotAction(genpy.Message):
  _md5sum = "2e0cbb948d05fd8840e6d52b1495628d"
  _type = "interfaces/MoveRobotAction"
...
"""
  ...
  _slot_types = ['interfaces/MoveRobotActionGoal','interfaces/MoveRobotActionResult','interfaces/MoveRobotActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = interfaces.msg.MoveRobotActionGoal()
      if self.action_result is None:
        self.action_result = interfaces.msg.MoveRobotActionResult()
      if self.action_feedback is None:
        self.action_feedback = interfaces.msg.MoveRobotActionFeedback()
    else:
      self.action_goal = interfaces.msg.MoveRobotActionGoal()
      self.action_result = interfaces.msg.MoveRobotActionResult()
      self.action_feedback = interfaces.msg.MoveRobotActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_dB3I().pack(_x.action_goal.goal.vel, _x.action_goal.goal.deployed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.vel, _x.action_goal.goal.deployed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_dB3I().unpack(str[start:end])
      self.action_goal.goal.deployed = bool(self.action_goal.goal.deployed)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
