...
namespace gazebo
{
    class LightOnOffPlugin : public ModelPlugin
    {
    ...
    public:
        void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
        {
            ...
            this->updateConnection = event::Events::ConnectWorldUpdateBegin(std::bind(&LightOnOffPlugin::OnUpdate, this));
    ...
    GZ_REGISTER_MODEL_PLUGIN(LightOnOffPlugin)
}